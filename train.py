...
flags.DEFINE_string("dataset", "clothing", "The name of dataset [celebA, mnist, lsun]")
...
flags.DEFINE_boolean("export", True, "True for exporting with new batch size")
flags.DEFINE_boolean("freeze", True, "True for exporting with new batch size")
